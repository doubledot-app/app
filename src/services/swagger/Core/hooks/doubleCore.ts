 ...
 */
import type { RefreshTokenDto, TelegramDto, Token, User } from '../models';
...
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof coreControllerGetHello>>, TError, TData>
  >;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof coreControllerGetHello>>> = ({ signal }) =>
    coreControllerGetHello(requestOptions, signal);
...
>(options: {
  ...
  > &
    Pick<
      DefinedInitialDataOptions<Awaited<ReturnType<typeof coreControllerGetHello>>, TError, TData>,
      'initialData'
    >;
  request?: SecondParameter<typeof coreMutator>;
...
>(options?: {
  query?: Partial<
    UseSuspenseQueryOptions<Awaited<ReturnType<typeof coreControllerGetHello>>, TError, TData>
  >;
  request?: SecondParameter<typeof coreMutator>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
...
export const userControllerFindMe = (
  ...
  return coreMutator<User>({ url: `/api/v1/user/me`, method: 'GET', signal }, options);
};
...
export const getUserControllerFindMeQueryOptions = <
  TData = Awaited<ReturnType<typeof userControllerFindMe>>,
  TError = ErrorType<unknown>
>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof userControllerFindMe>>, TError, TData>>;
  request?: SecondParameter<typeof coreMutator>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof userControllerFindMe>>> = ({ signal }) =>
    userControllerFindMe(requestOptions, signal);
...
export type UserControllerFindMeQueryResult = NonNullable<
  Awaited<ReturnType<typeof userControllerFindMe>>
>;
export type UserControllerFindMeQueryError = ErrorType<unknown>;

export function useUserControllerFindMe<
  TData = Awaited<ReturnType<typeof userControllerFindMe>>,
  TError = ErrorType<unknown>
>(options: {
  query: Partial<UseQueryOptions<Awaited<ReturnType<typeof userControllerFindMe>>, TError, TData>> &
    Pick<
      DefinedInitialDataOptions<Awaited<ReturnType<typeof userControllerFindMe>>, TError, TData>,
      'initialData'
    >;
  request?: SecondParameter<typeof coreMutator>;
}): DefinedUseQueryResult<TData, TError> & { queryKey: QueryKey };
...
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof userControllerFindMe>>, TError, TData>
  > &
    Pick<
      UndefinedInitialDataOptions<Awaited<ReturnType<typeof userControllerFindMe>>, TError, TData>,
      'initialData'
    >;
  request?: SecondParameter<typeof coreMutator>;
}): UseQueryResult<TData, TError> & { queryKey: QueryKey };
...
export const getUserControllerFindMeSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof userControllerFindMe>>,
  TError = ErrorType<unknown>
>(options?: {
  query?: Partial<
    UseSuspenseQueryOptions<Awaited<ReturnType<typeof userControllerFindMe>>, TError, TData>
  >;
  request?: SecondParameter<typeof coreMutator>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
...
export type UserControllerFindMeSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof userControllerFindMe>>
>;
export type UserControllerFindMeSuspenseQueryError = ErrorType<unknown>;

export function useUserControllerFindMeSuspense<
  TData = Awaited<ReturnType<typeof userControllerFindMe>>,
  TError = ErrorType<unknown>
>(options: {
  query: Partial<
